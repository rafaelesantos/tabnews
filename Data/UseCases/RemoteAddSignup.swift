...
public final class RemoteAddSignup: AddSignup, TabNewsHttpRequest {
    ...
    public func addSignup(withBody requestBody: SignupRequest) async -> AddSignup.Result {
