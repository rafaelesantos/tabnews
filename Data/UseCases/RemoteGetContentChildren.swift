//
//  RemoteGetContentChildren.swift
//  Data
//
...
public final class RemoteGetContentChildren: GetContentChildren, TabNewsHttpRequest {
    ...
    public func getContentChildren() async -> GetContentChildren.Result {
