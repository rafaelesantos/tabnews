...
public final class RemoteAddAnswer: AddAnswer, TabNewsHttpRequest {
    ...
    public func addAnswer(withBody requestBody: AnswerRequest) async -> AddAnswer.Result {
