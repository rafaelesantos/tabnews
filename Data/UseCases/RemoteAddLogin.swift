...
public final class RemoteAddLogin: AddLogin, TabNewsHttpRequest {
    ...
    public func addLogin(withBody requestBody: LoginRequest) async -> AddLogin.Result {
