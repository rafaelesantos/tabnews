//
//  RemoteGetAnalyticsChildContentPublished.swift
//  Data
//
...
public final class RemoteGetAnalyticsChildContentPublished: GetAnalyticsChildContentPublished, TabNewsHttpRequest {
    public typealias Response = [AnalyticsChildContentPublishedResponse]
    ...
    public func getAnalyticsChildContentPublished() async -> GetAnalyticsChildContentPublished.Result {
